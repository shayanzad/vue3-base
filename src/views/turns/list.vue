...
const headers = [
  ...
  { title: 'نام راننده', key: 'driverName', align: 'end' },
  { title: 'کد ملی راننده', key: 'nationalCode', align: 'end' },
  { title: 'استان', key: 'province', align: 'center' },
  { title: 'شهر', key: 'city', align: 'center' },
  { title: 'خط', key: 'line', align: 'center' },
]
const items = [
  {
    id: 1,
